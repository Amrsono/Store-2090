            ...
            <div className="relative z-10 h-full flex flex-col justify-between">
                <div>
                    <div className="flex items-center justify-between mb-6">
                        ...
                        <motion.div
                            ...
                            className="w-10 h-10 rounded-2xl gradient-modern flex items-center justify-center shadow-lg"
                        >
                ...
                <div className="flex items-center justify-between mt-auto">
                    ...
                    <motion.button
                        ...
                        className="gradient-modern px-8 py-3 rounded-full text-sm font-bold shadow-lg hover:neon-glow-blue transition-all duration-300"
                    >
