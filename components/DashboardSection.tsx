                ...
                >
                    <div className="flex flex-col md:flex-row items-center justify-between mb-8 gap-4">
                        ...
                        <div className="flex gap-2">
                            ...
                            <button className="gradient-modern px-4 py-2 rounded-xl text-sm neon-glow-blue">
                                {t.trending.month}
                            </button>
                            <button className="glass px-4 py-2 rounded-xl text-sm hover:neon-glow-blue transition-all duration-300">
                                {t.trending.year}
                    ...
                    >
                        ...
                        <div className="space-y-4">
                            {[
                                ...
                                >
                                    <div className="w-12 h-12 rounded-xl gradient-modern flex items-center justify-center">
                                ...
                                >
                                    ...
                                    <div className="w-full h-3 bg-white/5 rounded-full overflow-hidden">
                                        <motion.div
                                            ...
                                            className="h-full gradient-modern"
                                        />
                                    </div>
