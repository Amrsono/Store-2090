...
app = FastAPI(
    title="Modern Fashion API",
    description="2090s Modern Fashion Store Backend with GraphQL",
    version="1.0.0",
    root_path=root_path
)
...
async def health_check():
    return {"status": "healthy", "service": "modern-fashion-api"}
...
async def seed_database():
    ...
    try:
        ...
        seed_products()
        return {"status": "success", "message": "Database seeded successfully (Admin: admin@modern.com)"}
    except Exception as e:
        import traceback
