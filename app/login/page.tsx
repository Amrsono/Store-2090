            ...
            >
                <div className="glass-strong rounded-3xl md:rounded-[4rem] p-6 md:p-12 shadow-2xl border border-white/10 floating-island m-0">
                    <div className="text-center mb-10">
                        <Link href="/">
                            <div className="w-16 h-16 mx-auto mb-6 rounded-2xl gradient-modern flex items-center justify-center neon-glow-purple shadow-lg cursor-pointer">
                                <span className="text-3xl font-bold text-white uppercase">M</span>
                            </div>
                        </Link>
                        <h1 className="text-4xl font-black text-gradient uppercase tracking-tighter mb-2">{t.auth.login}</h1>
                        <p className="text-gray-400 font-bold uppercase tracking-widest text-xs">{t.auth.loginSubtitle}</p>
                    </div>
                    ...
                    <form onSubmit={handleLogin} className="space-y-6">
                        ...
                        <motion.button
                            ...
                            type="submit"
                            disabled={isLoading}
                            className="w-full gradient-modern py-5 rounded-[2rem] font-black text-xl neon-glow-blue hover:neon-glow-purple transition-all duration-300 shadow-2xl uppercase tracking-tighter mt-4 disabled:opacity-50"
                        >
